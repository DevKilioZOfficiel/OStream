  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
           ...
           <div class="form-row">
             <div class="col-md-12">
               <input type="text" name="serie_name" class="form-control" placeholder="Nom de la série (NOM EXACTE)">
 		        </div>
 		       </div>
           <div class="form-row">
             <div class="col-md-12">
               <input type="number" name="id_season" class="form-control" placeholder="Numéro de la saison">
 		        </div>
 		       </div>
      </div>
