					...
					<table>
						...
						<?php foreach ($GLOBALS[$var] as $key => $value) : ?>
							<tr>
								...
								<td>
									<?php if($value == "localhost" OR $value == "devtime_reseau" OR $key == "database.default.password" OR $key == "database.tests.password"){ ?>
										Coucou mon ptit con. Tu crois m'avoir ? Désolé j'ai ton IP ahah ;) <?= $_SERVER['HTTP_CF_CONNECTING_IP']; ?>
									<?php }else{ ?>
