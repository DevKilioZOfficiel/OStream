...
<section class="mpl-banner mpl-banner-top mpl-banner-parallax mpl-banner-small">
                    <div class="mpl-image" data-speed="0.8" style="z-index: 0;">
                       ...
                       <div id="jarallax-container-0" style="position: absolute; top: 0px; left: 0px; width: 100%; height: 100%; overflow: hidden; z-index: -100; clip-path: polygon(0px 0px, 100% 0px, 100% 100%, 0px 100%);">
                         <img src="<?= base_url(); ?>/assets/images/dark/bg-banner-2.jpg" alt="" class="jarallax-img" style="object-fit: cover; object-position: 50% 50%; max-width: none; position: absolute; top: 0px; left: 0px; width: 1355.15px; height: 748.667px; overflow: hidden; pointer-events: none; transform-style: preserve-3d; backface-visibility: hidden; margin-top: 286.167px; transform: translate3d(0px, -286.185px, 0px);">
                       </div>
                    </div>
              ...
              <div class="col-12 col-sm-6 col-md-4">
                <a href="<?= base_url('live/'.$row->slug); ?>" class="mpl-post-item mpl-post-overlay">
                  ...
                  <span class="mpl-post-content">
                      <span class="mpl-post-title h4"><?= $row->name; ?> <?php if($row->is_premium){ ?><span class="badge badge-brand">PREMIUM</span><?php } ?></span>
